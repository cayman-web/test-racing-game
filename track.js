...
const TRACKS = {
  ...
  /* Вторая трасса - по наброску с эсками, шпилькой и гравийными ловушками.
     Контур на бумаге не был замкнут (показана только техническая часть -
     от одной гравийной зоны до другой), поэтому обратная "быстрая" дуга,
     замыкающая круг, домыслена. Координаты гравия/питлейна приблизительные,
     считаны вручную по клеточкам скетча. */
  'sketch-esses-hook-02': {
    name: 'Esses & Hook',
    width: 13,
    waypoints: [
      [895,1300],[830,1230],[790,1150],[785,1070],[820,1000],[890,960],
      [955,920],[900,850],[770,820],[705,890],[730,970],[820,965],
      [930,900],[1005,800],[1055,700],[1090,630],[1140,670],[1180,610],
      [1230,580],[1290,610],
      [1420,520],[1550,650],[1600,850],[1550,1050],[1400,1200],[1200,1320],[1050,1330]
    ],
    // Гравийно-песочные зоны вылета - тилтованные прямоугольники у обеих
    // самых острых точек трассы (шпилька и связка перед стартовой прямой)
    gravelZones: [
      [ [760,1260], [650,1380], [870,1580], [980,1460] ],
      [ [1160,660], [1280,480], [1400,580], [1270,760] ]
    ],
    // Питлейн - короткая объездная дорожка от вершины шпильки до стартовой прямой
    pitlane: {
      waypoints: [ [730,970], [650,1250], [610,1550] ],
      width: 8,
      speedLimitKmh: 80
    }
  }
